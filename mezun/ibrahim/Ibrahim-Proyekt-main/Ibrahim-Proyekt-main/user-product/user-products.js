document.getElementById("addBtn").addEventListener("click", () => {
    window.location.href = "../AddProduct/add_product.html";
  });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("http://localhost:8084/product/my-products", {
    method: "GET",
    headers: {
...
document.getElementById("productForm").addEventListener("submit", async (e) => {
  ...
  const res = await fetch("http://localhost:8084/product/update", {
    method: "PUT",
    headers: {
...
function deleteProduct(id) {
  ...
  fetch(`http://localhost:8084/product/delete/${id}`, {
    method: "DELETE",
    headers: {
      "Authorization": "Bearer " + token
    }
